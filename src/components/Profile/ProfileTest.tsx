...
const ProfileTest = () => {
  const image =
    'https://images.unsplash.com/photo-1574701148212-8518049c7b2c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1000&q=80';
      ...
      <div className={styles.profile__info}>
          ...
          <div className={styles.profile__imageInner}>
            {image.length ? (
              ...
              <img
                ...
                src="https://pngimage.net/wp-content/uploads/2018/06/no-profile-image-png.png"
                alt=""
              />
            )}
          </div>
        ...
        <div className={styles.profile__infoMain}>
          <div className={styles.profile__nameBlock}>
            <h1 className={styles.profile__userName}>Ann Bright</h1>
          ...
          {/*    <a className={styles.friends__all} href="#">*/}
          {/*      All friends*/}
          {/*    </a>*/}
          {/*  </p>*/}
          ...
          {/*      <img*/}
          {/*        className={styles.friend__image}*/}
          {/*        src="https://upload.wikimedia.org/wikipedia/commons/4/49/Jonathan_G_Meath_portrays_Santa_Claus.jpg"*/}
          {/*        alt=""*/}
          {/*      />*/}
          {/*    </a>*/}
          {/*    <a className={styles.friend} href="#">*/}
          {/*      <img*/}
          {/*        className={styles.friend__image}*/}
          {/*        src="https://www.disneyplusinformer.com/wp-content/uploads/2022/03/Turning-Red-Profile-Avatar.png"*/}
          {/*        alt=""*/}
          {/*      />*/}
          {/*    </a>*/}
          {/*  </div>*/}
      ...
      <div className={styles.profile__additional}>
        ...
        <div className={styles.profile__publications}>
          <div className={styles.publication}>
            ...
            <div className={styles.publication__content}>
              <div className={styles.publication__text}>
                Tak vazhko bez nyogo, ale treba mastutu. I ne rozcharyvatu yogo. Ya bydy kachatu pres poku vin ne
                pruide!
              </div>
              <img
                className={styles.publication__image}
                src="https://images.unsplash.com/photo-1574701148212-8518049c7b2c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1000&q=80"
                alt=""
              />
            </div>
          ...
          <div className={styles.publication}>
            ...
            <div className={styles.publication__content}>
              {/*<div className={styles.publication__text}>Sho takoe? De vin? Ne mozhy trenyvatus' :(</div>*/}
          ...
          <div className={styles.publication}>
            ...
            <div className={styles.publication__content}>
              <div className={styles.publication__text}>This is my results. See you in the GYM. (Z ponedilka)</div>
              <img
                className={styles.publication__image}
                src="https://damion.club/uploads/posts/2022-01/1642459018_2-damion-club-p-foni-so-sportivnimi-devushkami-2.jpg"
                alt=""
              />
            </div>
            <div className={styles.publication__total}>
